...
struct  ClientSessionInfo_t1214  : public Object_t
{
	...
	ByteU5BU5D_t504* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t504* ___masterSecret_5;
};
struct ClientSessionInfo_t1214_StaticFields{
