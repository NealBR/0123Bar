...
struct  ExtendedKeyUsageExtension_t1187  : public X509Extension_t993
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t924 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t1187_StaticFields{
	...
	Dictionary_2_t486 * ___U3CU3Ef__switch$map14_4;
};
