...
struct  X509EnhancedKeyUsageExtension_t999  : public X509Extension_t977
{
	...
	OidCollection_t996 * ____enhKeyUsage_4;
...
struct X509EnhancedKeyUsageExtension_t999_StaticFields{
	...
	Dictionary_2_t486 * ___U3CU3Ef__switch$mapE_6;
};
