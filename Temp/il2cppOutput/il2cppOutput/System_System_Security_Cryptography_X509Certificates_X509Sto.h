...
struct  X509Store_t991  : public Object_t
{
	...
	X509Certificate2Collection_t981 * ___list_2;
	...
	X509Store_t1007 * ___store_4;
};
struct X509Store_t991_StaticFields{
	...
	Dictionary_2_t486 * ___U3CU3Ef__switch$mapF_5;
};
